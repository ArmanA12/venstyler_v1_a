        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56 fashion-card border-0">
            {isAuthenticated ? (
              ...
              <>
                <DropdownMenuItem asChild><Link to="/signin"><User className="w-4 h-4 mr-2" /> Sign In</Link></DropdownMenuItem>
                <DropdownMenuItem asChild><Link to="/signup"><UserPlus className="w-4 h-4 mr-2" /> Sign Up</Link></DropdownMenuItem>
              </>
            )}
          </DropdownMenuContent>
        </DropdownMenu>
  ...
  {mobileMenuOpen && (
    <div className="md:hidden bg-background px-4 py-4 border-t border-border/50 space-y-4">
      <div className="flex flex-col space-y-3">
        ...
        {!isAuthenticated && (
          <>
            <Link to="/signin" className="flex items-center gap-2"><User className="w-5 h-5" /> Sign In</Link>
            <Link to="/signup" className="flex items-center gap-2"><UserPlus className="w-5 h-5" /> Sign Up</Link>
          </>
        )}
      </div>
    </div>

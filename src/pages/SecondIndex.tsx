...
const Showcase: React.FC = () => {
  ...
  return (
    <section ref={targetRef} className="bg-[#030303] relative h-[220vh]">
      <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 mb-12 text-center z-10 pt-8">
        ...
        <motion.div style={{ x }} className="flex gap-8 pl-[5vw] z-20 items-center">
          {images.map((src, i) => (
...
const Collections: React.FC = () => {
  const products = [{ title: "Silver Sequined Ruffle Lehenga", designer: "Ikra Hand & Embroidery Work", price: 9000, oldPrice: 12000, image: "https://picsum.photos/id/1/400/500", likes: 24 }, { title: "Emerald Green Floral Anarkali", designer: "Ikra Hand & Embroidery Work", price: 2790, oldPrice: 3500, image: "https://picsum.photos/id/20/400/500", likes: 42 }, { title: "Ivory Floral Hand-Embroidered", designer: "Ikra Hand & Embroidery Work", price: 380, oldPrice: 480, image: "https://picsum.photos/id/30/400/500", likes: 18 }];
  return (
    ...
    <footer className="bg-black border-t border-white/10 pt-24 pb-0 relative overflow-hidden flex flex-col justify-between min-h-[80vh]">
      ...
      <div className="w-full relative -mb-6 z-0 pointer-events-none select-none opacity-80">
         <svg viewBox="0 0 1350 200" className="w-full h-auto">
            <defs><linearGradient id="cyanGradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#22d3ee" /><stop offset="100%" stopColor="#0ea5e9" /></linearGradient></defs>
            ...
            <text x="50%" y="85%" textAnchor="middle" className="font-sans font-black tracking-tighter" style={{ fontSize: '180px', fill: '#000000', stroke: '#22d3ee', strokeWidth: '0.5px' }}>VENSTYLER</text>
         </svg>
      </div>
    </footer>
  );
